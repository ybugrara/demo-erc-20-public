...
describe("GLDToken::allowance(address,address)", async () => {
  ...
  it("0x7ec09", async () => {
    // http://172.16.0.71/internal/root/0x7721f/path/0x7dc23
  ...
  it("0x7a3eb", async () => {
    // http://172.16.0.71/internal/root/0x7721f/path/0x77b90
